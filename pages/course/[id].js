              ...
              <div class="  h-[60rem]  w-full max-w-[28rem] flex-col rounded-xl bg-zinc-100 p-8 text-black ">
                ...
                <div>
                  ...
                  <Stack direction="row" alignItems="center" gap={1} marginBottom={1} >
                    ...
                    <Typography variant="body1" fontSize={15}> Access on all devices</Typography>
                  </Stack>

                  <Stack direction="row" alignItems="center" gap={1} marginBottom={1}>
                    < ArticleIcon fontSize='small' color='info' />
                    <Typography variant="body1" fontSize={15}>39 articles</Typography>
                  </Stack>

                  <Stack direction="row" alignItems="center" gap={1} marginBottom={1}>
                    <OndemandVideoIcon fontSize='small' color='info' />
                    <Typography variant="body1" fontSize={15}>42 hours on-demand video</Typography>
                  </Stack>

                  <Stack direction="row" alignItems="center" gap={1} marginBottom={2}>
                    < EmojiEventsIcon fontSize='small' color='info' />
                    <Typography variant="body1" fontSize={15}> Certificate of completion</Typography>
                  </Stack>
              ...
              <div class="max-w-[50rem] mt-3 p-6 bg-white border border-gray-200 rounded-lg shadow bg-zinc-100 drop-shadow-xl flex flex-wrap ">
                ...
                <ul class="mb-8 space-y-4 text-left text-gray-500 dark:text-black lg:columns-2 sm:columns-1 lg:w-[47rem] sm:w-[24rem]  gap-[10rem]">
                  <li class="flex space-x-3">
                    ...
                    <Typography variant="body1" fontSize={"15px"}>Automate tasks on their computer by writing simple Python programs. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Programmatically generate and update Excel spreadsheets. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Crawl web sites and pull information from online sources. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Use Python's debugging tools to quickly figure out bugs in your code. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Parse PDFs and Word documents. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Write programs that send out email notifications. </Typography>
                  </li>
                  <li class="flex space-x-3">

                    <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                    <Typography variant="body1" fontSize={"15px"}>Programmatically control the mouse and keyboard to click and type for you. </Typography>
                  </li>
